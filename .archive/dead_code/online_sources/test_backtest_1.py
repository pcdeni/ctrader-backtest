...
def test_backtest():
    ...
    initizalize('C:\\Program Files\\\MetaTrader 5\\terminal64.exe')
    ...
    param = {
             'max_unit': {'value': 0.1},
             'spread_difference': {'value': 0.02, 'max': 0.2, 'interval': 0.05},
             'gridstep': {'value': 3.0},
             'stop_loss_limit': {'value': 12},
             'angle': {'value': 6}
             }
